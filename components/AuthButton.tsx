...
export function AuthButton() {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="hidden text-xs text-zinc-500 sm:inline">Anónimo</span>
      <Button onClick={signInWithGoogle} variant="outline" size="sm" className="border-zinc-700 text-zinc-300 hover:bg-zinc-800 hover:text-zinc-100">
